...
Definition Tileable_nm (n m : nat)(b : boundary) :=
 Boundary_vertical n m b (e'_nm n m b) /\ Boundary_horizontal n m b (e_nm n m b) /\
...
rewrite /Tileable_nm/Boundary_vertical/Boundary_horizontal/Brick/e'_nm/e_nm/enm_to_emn/bnm_to_bmn/bSnm_to_b1m/bSnm_to_bnm/e'_1m.
elim => H1.
elim => H2 H3.
repeat split.
clear H2 H3.
...
rewrite /Tileable_nm/Boundary_vertical/Boundary_horizontal/Brick.
elim => H2.
elim => H3 H4.
repeat split.
clear H3 H4.
