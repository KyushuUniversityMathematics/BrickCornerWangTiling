...
(** val eq_to_bin : int -> int -> int **)

let rec eq_to_bin n m =
...
(** val eq_to_if : int -> int -> int -> int -> int **)

let eq_to_if n m p q =
  (fun fO fS n -> if n=0 then fO () else fS (n-1))
    (fun _ ->
    p)
    (fun n0 ->
...
let e'_12 b i j =
  (fun fO fS n -> if n=0 then fO () else fS (n-1))
    ...
    (fun fO fS n -> if n=0 then fO () else fS (n-1))
      (fun _ ->
      eq_to_if (b (Pervasives.succ 0) 0)
        (b (Pervasives.succ 0) (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0))))
        (eq_to_if (b 0 (Pervasives.succ 0))
          (b (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ 0))
          (c_other2 (b (Pervasives.succ 0) 0)) (b (Pervasives.succ 0) 0))
        (eq_to_if (b 0 (Pervasives.succ 0))
          (b (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ 0))
          (eq_to_if (b 0 (Pervasives.succ (Pervasives.succ 0)))
            (b (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
              (Pervasives.succ 0)))
            (c_other3 (b (Pervasives.succ 0) 0)
              (b (Pervasives.succ 0) (Pervasives.succ (Pervasives.succ
                (Pervasives.succ 0)))))
            (b (Pervasives.succ 0) (Pervasives.succ (Pervasives.succ
              (Pervasives.succ 0))))) (b (Pervasives.succ 0) 0)))
      (fun n0 ->
      b (Pervasives.succ 0) (Pervasives.succ (Pervasives.succ
        (Pervasives.succ 0))))
      n)
  ...
  (fun fO fS n -> if n=0 then fO () else fS (n-1))
    ...
    (fun fO fS n -> if n=0 then fO () else fS (n-1))
      ...
      eq_to_if (b (Pervasives.succ 0) 0)
        (b (Pervasives.succ 0) (Pervasives.succ (Pervasives.succ
          (Pervasives.succ 0))))
        (eq_to_if (b (Pervasives.succ (Pervasives.succ 0)) 0)
          (b (Pervasives.succ (Pervasives.succ 0)) (Pervasives.succ
